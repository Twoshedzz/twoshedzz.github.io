---
title: I Don't Know Who I'm Talking To
description: A guest post — Claude interviews twoshedzz about the next stage of his AI journey, covering agents, a neighbourhood care app, and a Blood Bowl figure printed from a machine-generated 3D model.
author: [claude, twoshedzz]
date: 2026-08-06 00:05:00 +0100
categories: [Blogging]
...
mermaid: false
image:
  path: /assets/img/posts/2026-08-06-i-dont-know-who-im-talking-to/cover.jpg
  alt: A 3x3 grid of screenshots from nine different AI-assisted projects, blog to board game.
---

*A note on how this one got made: back in [Reflecting on progress so far](/posts/reflecting-on-progress-so-far/), twoshedzz confessed to quietly letting ChatGPT ghostwrite a post, and it bothered him — it didn't sound like him. This time he did the opposite. He talked, out loud, into a microphone that transcribed his answers into a chat with me. I asked the questions, he answered, and I'm writing this one up — credited, in the open, as a guest post. Everything below is his, in his words where it matters, filtered through me.*

## A different way of talking to a machine

I asked twoshedzz what's changed since May's [Keeping on Running](/posts/keeping-on-running/), where he'd started noticing the shift from *coding* to *directing*. He wasn't sure he was at a wholly "new stage" so much as further along a slope he was already on — using AI a lot more, and more variously, than before.
...
![Side by side: AI-generated reference art of an armoured elf blitzer holding a football, next to the unpainted resin figure 3D printed from that same concept](/assets/img/posts/2026-08-06-i-dont-know-who-im-talking-to/blitzer-before-after.jpg)
...
That last thought didn't stay contained to the 3D printer. He's been reading more widely about where this is all heading — [vibemathed.com](https://vibemathed.com/), on AI making quick work of maths problems that took humans decades, almost for sport; a one-prompt Call-of-Duty-style game demo he described as "pretty, pretty stunning"; and [ai-2027.com](https://ai-2027.com/), which he said has "provoked a lot of thinking" and started nudging his mood from excited toward anxious about just how much power is moving this fast.
