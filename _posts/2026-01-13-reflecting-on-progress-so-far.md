---
title: Reflecting on progress so far
description: Reflections on using AI for coding, the importance of authentic writing, and hitting the ceiling of understanding
author: twoshedzz
...
I've also read a couple of good posts by others much cleverer than me. A lifetime ago, Simon Willison did a stint at Capital Radio when I was there. I was blown away by how clever he is. Unsurprisingly, he is writing interesting stuff about AI. A lot of it is above my head, but this post is accessible for mere mortals in the land of coding [Not all AI-assisted programming is vibe coding (but vibe coding rocks)](https://simonwillison.net/2025/Mar/19/vibe-coding/). And there are loads more on his extensive blog.

I also found this to be really good [Augmented coding patterns](https://lexler.github.io/augmented-coding-patterns/talk/) by Lada Kesseler. There's a link to a Youtube video there where she explains it.

There are some concepts that Lada explains that I've encountered and clumsily tried to explain. For example in my [Back on the AI wagon](https://twoshedzz.github.io/posts/back-on-the-ai-wagon/) post, I talked about Cursor forgetting about a big refactor and undoing it. This is a combination of what is referred to (by Lada) as compliance bias; trying to satisfy the latest prompt, and context rot; forgetting what was going on a few prompts ago. These are things. Reassuring that it's not just me.
